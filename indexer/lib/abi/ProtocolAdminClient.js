...
exports.events = {
    ...
    ProtocolCreated: (0, evm_abi_1.event)("0x7d7be2210e89bf2b0b05e032a03e508fd69d76ca336d02a6f60068a4839ffee4", "ProtocolCreated(address,uint256,address)", {
        "protocolCaller": (0, evm_abi_1.indexed)(p.address),
        "tokenId": (0, evm_abi_1.indexed)(p.uint256),
        "protocolAdminManager": (0, evm_abi_1.indexed)(p.address)
    }),
};
exports.functions = {
    ...
    initialize_admin_panel: (0, evm_abi_1.fun)("0x91adaf44", "initialize_admin_panel(address,address,string)", {
