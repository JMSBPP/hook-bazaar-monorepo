...
import {
  ...
  useMergeRefs,
  zeroRightClassName
} from "./chunk-QWA5NPJL.js";
import {
  Log_exports,
  TransactionReceipt_exports,
  bls12_381,
  ens_normalize
} from "./chunk-WBWR6BPR.js";
import {
  AbiError_exports,
  Base64_exports,
  HDKey,
...
import {
  ...
  polygonAmoy,
  sepolia
} from "./chunk-DQLRBXEN.js";
import "./chunk-JXCNRWCE.js";
import {
...
function calcElligatorRistrettoMap(r0) {
  ...
  const Ns = mod3((r + _1n3) * ONE_MINUS_D_SQ);
  let c = BigInt(-1);
  ...
  if (!Ns_D_is_sq)
    c = r;
  const Nt = mod3(c * (r - _1n3) * D_MINUS_ONE_SQ - D);
  const s2 = s * s;
  const W0 = mod3((s + s) * D);
  ...
  return createConnector((config) => ({
    ...
    async getProvider() {
      if (!walletProvider) {
        ...
        const { createBaseAccountSDK } = await import("./dist-EKESN7BJ.js");
  ...
  return createConnector((config) => ({
    ...
    async getProvider() {
      if (!walletProvider) {
        ...
        const { createCoinbaseWalletSDK } = await import("./dist-52XYV5LR.js");
    ...
    async getProvider() {
      ...
      if (!walletProvider) {
        const CoinbaseWalletSDK = await (async () => {
          const { default: SDK } = await import("./dist-XXWAZECZ.js");
    ...
    async getProvider() {
      async function initProvider() {
        ...
        const MetaMaskSDK = await (async () => {
          const { default: SDK } = await import("./metamask-sdk-64M7ORMP.js");
          if (typeof SDK !== "function" && typeof SDK.default === "function")
            return SDK.default;
          return SDK;
        })();
  ...
  return createConnector((config) => ({
    ...
    async getProvider() {
      ...
      if (!isIframe)
        return;
      if (!provider_) {
        const { default: SDK } = await import("./esm-GAGNC2TA.js");
        ...
        const SafeAppProvider = await (async () => {
          const Provider = await import("./dist-N4MOBSAM.js");
    ...
    async getProvider({ chainId } = {}) {
      ...
      async function initProvider() {
        ...
        if (!optionalChains.length)
          return;
        const { EthereumProvider } = await import("./index.es-DZCBCPZD.js");
...
function DownloadDetail({
  ...
  return import_react66.default.createElement(
    ...
    import_react66.default.createElement(Box, { height: "full" }, (downloadUrls == null ? void 0 : downloadUrls.qrCode) ? import_react66.default.createElement(QRCode, { logoSize: 0, size: 268, uri: downloadUrls.qrCode }) : null),
    import_react66.default.createElement(
      Box,
      {
        alignItems: "center",
        ...
        import_react74.default.createElement(
          ...
          import_react74.default.createElement(
            ...
            import_react74.default.createElement(
              ...
              import_react74.default.createElement(Box, { testId: `wallet-button-label-${(connector == null ? void 0 : connector.id) || ""}` }, loading ? i18n2.t("connect.status.connecting", {
                wallet: connectorName
              }) : connectorName)
            ),
