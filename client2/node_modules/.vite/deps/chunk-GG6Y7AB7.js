...
var ICONS = {
  add: async () => (await import("./add-L7CGXZQS.js")).addSvg,
  allWallets: async () => (await import("./all-wallets-JWMPKMMP.js")).allWalletsSvg,
  arrowBottomCircle: async () => (await import("./arrow-bottom-circle-2AM7POCH.js")).arrowBottomCircleSvg,
  appStore: async () => (await import("./app-store-EG4RIAXD.js")).appStoreSvg,
  apple: async () => (await import("./apple-EJLUMXZS.js")).appleSvg,
  arrowBottom: async () => (await import("./arrow-bottom-GV65JBCU.js")).arrowBottomSvg,
  arrowLeft: async () => (await import("./arrow-left-JIPTXETR.js")).arrowLeftSvg,
  arrowRight: async () => (await import("./arrow-right-X3NQQDAL.js")).arrowRightSvg,
  arrowTop: async () => (await import("./arrow-top-Y4H3ILBQ.js")).arrowTopSvg,
  bank: async () => (await import("./bank-WQOIBKDN.js")).bankSvg,
  browser: async () => (await import("./browser-RO3ODDRS.js")).browserSvg,
  card: async () => (await import("./card-5JYWFNNF.js")).cardSvg,
  checkmark: async () => (await import("./checkmark-BELFZVEC.js")).checkmarkSvg,
  checkmarkBold: async () => (await import("./checkmark-bold-7MANKVY6.js")).checkmarkBoldSvg,
  chevronBottom: async () => (await import("./chevron-bottom-IDXYA5D6.js")).chevronBottomSvg,
  chevronLeft: async () => (await import("./chevron-left-UYMMXNO6.js")).chevronLeftSvg,
  chevronRight: async () => (await import("./chevron-right-3IQLNKKG.js")).chevronRightSvg,
  chevronTop: async () => (await import("./chevron-top-Z5U2MUU2.js")).chevronTopSvg,
  chromeStore: async () => (await import("./chrome-store-E6PH33SC.js")).chromeStoreSvg,
  clock: async () => (await import("./clock-E6XPANIO.js")).clockSvg,
  close: async () => (await import("./close-EUTCHRJZ.js")).closeSvg,
  compass: async () => (await import("./compass-ISVVYIHZ.js")).compassSvg,
  coinPlaceholder: async () => (await import("./coinPlaceholder-ZH4OBEPZ.js")).coinPlaceholderSvg,
  copy: async () => (await import("./copy-KIAGEOSF.js")).copySvg,
  cursor: async () => (await import("./cursor-YYIFZXT7.js")).cursorSvg,
  cursorTransparent: async () => (await import("./cursor-transparent-77Y2SQOP.js")).cursorTransparentSvg,
  desktop: async () => (await import("./desktop-VUJUP2LA.js")).desktopSvg,
  disconnect: async () => (await import("./disconnect-KEX3U73D.js")).disconnectSvg,
  discord: async () => (await import("./discord-HWN63VFR.js")).discordSvg,
  etherscan: async () => (await import("./etherscan-WVV6LO52.js")).etherscanSvg,
  extension: async () => (await import("./extension-EVA5DLA4.js")).extensionSvg,
  externalLink: async () => (await import("./external-link-2WBQSUDK.js")).externalLinkSvg,
  facebook: async () => (await import("./facebook-ZPP6H4OW.js")).facebookSvg,
  farcaster: async () => (await import("./farcaster-J6TOR3FQ.js")).farcasterSvg,
  filters: async () => (await import("./filters-W23JXPXH.js")).filtersSvg,
  github: async () => (await import("./github-DNAGJHHC.js")).githubSvg,
  google: async () => (await import("./google-3J6K4FK2.js")).googleSvg,
  helpCircle: async () => (await import("./help-circle-FYUIRGHV.js")).helpCircleSvg,
  image: async () => (await import("./image-LRS3AJ5H.js")).imageSvg,
  id: async () => (await import("./id-CVAYQBEV.js")).idSvg,
  infoCircle: async () => (await import("./info-circle-NWIQGIHY.js")).infoCircleSvg,
  lightbulb: async () => (await import("./lightbulb-XXUAYJKX.js")).lightbulbSvg,
  mail: async () => (await import("./mail-2PAG6DOT.js")).mailSvg,
  mobile: async () => (await import("./mobile-JFGMTMNX.js")).mobileSvg,
  more: async () => (await import("./more-HTP7ZMOV.js")).moreSvg,
  networkPlaceholder: async () => (await import("./network-placeholder-WGQPQOW4.js")).networkPlaceholderSvg,
  nftPlaceholder: async () => (await import("./nftPlaceholder-K6LEWVTW.js")).nftPlaceholderSvg,
  off: async () => (await import("./off-TKXULIDM.js")).offSvg,
  playStore: async () => (await import("./play-store-LIQ6DZNC.js")).playStoreSvg,
  plus: async () => (await import("./plus-6KUGWTPA.js")).plusSvg,
  qrCode: async () => (await import("./qr-code-YQMPFXA2.js")).qrCodeIcon,
  recycleHorizontal: async () => (await import("./recycle-horizontal-HKYUFDBB.js")).recycleHorizontalSvg,
  refresh: async () => (await import("./refresh-SHODQ2DY.js")).refreshSvg,
  search: async () => (await import("./search-OPIVBV4F.js")).searchSvg,
  send: async () => (await import("./send-XQXJZV4Z.js")).sendSvg,
  swapHorizontal: async () => (await import("./swapHorizontal-TSXBO3YX.js")).swapHorizontalSvg,
  swapHorizontalMedium: async () => (await import("./swapHorizontalMedium-STMO5CZV.js")).swapHorizontalMediumSvg,
  swapHorizontalBold: async () => (await import("./swapHorizontalBold-GE3RPOMN.js")).swapHorizontalBoldSvg,
  swapHorizontalRoundedBold: async () => (await import("./swapHorizontalRoundedBold-PJZM5MX2.js")).swapHorizontalRoundedBoldSvg,
  swapVertical: async () => (await import("./swapVertical-QTUUBM26.js")).swapVerticalSvg,
  telegram: async () => (await import("./telegram-EKYSXFFL.js")).telegramSvg,
  threeDots: async () => (await import("./three-dots-E3DMWRD6.js")).threeDotsSvg,
  twitch: async () => (await import("./twitch-ABVEKBOD.js")).twitchSvg,
  twitter: async () => (await import("./x-SAYFOVZB.js")).xSvg,
  twitterIcon: async () => (await import("./twitterIcon-6XLTM3O3.js")).twitterIconSvg,
  verify: async () => (await import("./verify-P7EAQC2V.js")).verifySvg,
  verifyFilled: async () => (await import("./verify-filled-6O72CZHP.js")).verifyFilledSvg,
  wallet: async () => (await import("./wallet-B5KN2T4M.js")).walletSvg,
  walletConnect: async () => (await import("./walletconnect-CGGQNXSV.js")).walletConnectSvg,
  walletConnectLightBrown: async () => (await import("./walletconnect-CGGQNXSV.js")).walletConnectLightBrownSvg,
  walletConnectBrown: async () => (await import("./walletconnect-CGGQNXSV.js")).walletConnectBrownSvg,
  walletPlaceholder: async () => (await import("./wallet-placeholder-TG47JSSI.js")).walletPlaceholderSvg,
  warningCircle: async () => (await import("./warning-circle-WWFENQYT.js")).warningCircleSvg,
  x: async () => (await import("./x-SAYFOVZB.js")).xSvg,
  info: async () => (await import("./info-MEN2HGUK.js")).infoSvg,
  exclamationTriangle: async () => (await import("./exclamation-triangle-YFVVW5NX.js")).exclamationTriangleSvg,
  reown: async () => (await import("./reown-logo-5XDZGB32.js")).reownSvg
};
...
lit-html/development/directive-helpers.js:
   ...
   *)
*/
//# sourceMappingURL=chunk-GG6Y7AB7.js.map
