...
Your main job is to convert this React + Vite component library application into a production-ready full-stack Next.js application with Supabase backend.
...
- NextJS,
- RainbowKit,
- Wagmi and Typescript. 


The structure is a yarn monorepo that contains following packages:
...
- Go to the `http://localhost:3000/debug` page to interact with your contract using a nice UI (this is only applicable where there are contract packages)
